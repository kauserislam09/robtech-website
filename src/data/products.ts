...
export const PRODUCTS: Product[] = [
  {
    ...
    latestVersion: '1.2.0',
    apkSize: '14.7 MB',
    downloadUrl: '/update/releases/rob-personal-stock-v1.2.0.apk',
  ...
  },
  {
    ...
    latestVersion: '2.0.1',
    apkSize: '8.5 MB',
    downloadUrl: '/update/releases/rob-music-player-v2.0.1.apk',
    documentationUrl: '/docs',
    privacyUrl: '/privacy',
    supportUrl: '/support',
    features: [
  ...
  },
  {
    ...
    latestVersion: '1.0.4',
    apkSize: '6.2 MB',
    downloadUrl: '/update/releases/rob-drop-offline-v1.0.4.apk',
    documentationUrl: '/docs',
    privacyUrl: '/privacy',
    supportUrl: '/support',
    features: [
  ...
  },
  {
    ...
    apkSize: '11.1 MB',
    downloadUrl: '/update/releases/rob-warranty-wallet-v0.9.0.apk',
    documentationUrl: '/docs',
    privacyUrl: '/privacy',
    supportUrl: '/support',
    features: [
  ...
  },
  {
    ...
    status: 'development',
    featured: false,
    latestVersion: '0.5.0-dev',
    apkSize: '9.8 MB',
    downloadUrl: undefined, // Simulates download currently unavailable state
    documentationUrl: '/docs',
    privacyUrl: '/privacy',
    supportUrl: '/support',
    features: [
